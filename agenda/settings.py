"""
Django settings for projetosistemaponto project.
...
SECRET_KEY = 'django-insecure-@r3!(vp8)^sf&xsc^#2szy4bksmk@tmoh7&%dfw_w$ky%eoqtm'
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'agenda.global.is_usuario_logado',
                'agenda.global.get_user',
            ],
        },
    },
]
